...
const en: Dict = {
  ...
  "app.planner": "Event Planner",
  "app.planner.desc": "Planners running events across many locations.",
...
const ar: Dict = {
  ...
  "app.planner": "منظم المناسبات",
  "app.planner.desc": "منظمون يديرون مناسبات في أماكن متعددة.",
